...
CRESS_DIR=/workspace/s2t/cress_raw
...
ckpt=/workspace/s2t/en-de/checkpoints/en-de.postln.wmt_pretrain.mustc_mt_pretrain.mustc_mt_deltalm_ft_v3_raw/checkpoint10.pt
