...
from ._transformer_layer import TransformerEncoderLayer, TransformerDecoderLayer
from ._transformer_decoder_lora import LoraTransformerDecoderBase
...
@register_model("deltalm_transformer_adapter_emd_share_lora")
...
class DeltaLMDecoder(LoraTransformerDecoderBase):
...
class DeltalmTransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary=None, embed_tokens=None, return_fc=False):
        ...
        for index, layer in enumerate(range(len(self.transformer_layers))):
            ...
            self.transformer_layers[index].load_state_dict(new_deltalm_state_dict[index], strict=False)
...
@register_model_architecture(model_name="deltalm_transformer_adapter_emd_share_lora", arch_name="deltalm_transformer_adapter_emd_share_lora")
def base_architecture(args):
    # subsampler
